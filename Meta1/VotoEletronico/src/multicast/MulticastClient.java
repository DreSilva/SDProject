...
/**
 * The multicast.MulticastClient class joins a multicast group and loops receiving
 * messages from that group. The client also runs a multicast.MulticastUser thread that
 ...
 * <p>
 * Usage: java -Djava.net.preferIPv4Stack=true multicast.MulticastClient
 *
 * @author Raul Barbosa
 * @version 1.0
 */
...
public class MulticastClient extends Thread {
     ...
     * Lança a thread multicast.MulticastClient(recebe mensagens)
     * Lança a thread multicast.MulticastServer(envia resposta)
    ...
    public static void main(String[] args) throws IOException {
        ...
        if (args.length == 2) {
            ...
            System.out.println("Corra com o número de departamento: java multicast.MulticastClient <clientID> <Departamento>");
            System.exit(0);
        }
...
class MulticastUser extends Thread {
    ...
    public MulticastUser(String MULTICAST_ADDRESS,int PORT) {
        super("models.User " + (long) (Math.random() * 1000));
