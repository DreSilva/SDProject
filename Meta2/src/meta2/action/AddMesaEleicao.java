...
public class AddMesaEleicao extends ActionSupport implements SessionAware {
    ...
    public String execute() throws Exception {
        for (String mesa: this.mesa) {
            this.getHeyBean().addMesaEleicao(Integer.parseInt(mesa));
        }
        return SUCCESS;
    }
