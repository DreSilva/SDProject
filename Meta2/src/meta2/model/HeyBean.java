...
public class HeyBean {
	...
	public ArrayList<String> getUserMessages() throws RemoteException{
		return this.server.getUserMessages(this.username);
	}

	public void addMessageUser(String user) throws RemoteException{
		this.server.addMessageUser(user,"Hey from "+this.username);
	}
